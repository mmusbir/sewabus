...
@section('title', 'Edit Akun Pengguna - Panel Admin')
...
<div class="max-w-3xl space-y-4">
    ...
    <form action="{{ route('admin.settings.users.update', $userAccount) }}" method="POST" class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 shadow-sm space-y-6">
        @csrf
        @method('PUT')
