...
@section('title', 'Tambah Paket - Panel Admin')
@section('header_title', 'Tambah Paket Sewa / Liburan')
...
<form action="{{ route('admin.rental-packages.store') }}" method="POST" enctype="multipart/form-data" class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 shadow-sm max-w-3xl">
    @csrf
